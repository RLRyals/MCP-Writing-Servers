...
export const WHITELIST = {
    ...
    outline_works: ['id', 'parent_id', 'work_type', 'sequence', 'title', 'summary', 'content', 'status', 'pov_character_id', 'series_id', 'book_id', 'chapter_id', 'scene_id', 'created_at', 'updated_at'],
