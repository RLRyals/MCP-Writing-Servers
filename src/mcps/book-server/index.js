...
if (process.env.MCP_STDIO_MODE !== 'true') {
    console.error('[BOOK-SERVER] normalized current module url:', normalizedCurrentModuleUrl);
    console.error('[BOOK-SERVER] normalized script path:', normalizedScriptPath);
